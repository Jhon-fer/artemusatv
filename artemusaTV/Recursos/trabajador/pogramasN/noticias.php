        ...
        .then(noticias => {
          ...
          if (Array.isArray(noticia.subtitulos) && Array.isArray(noticia.comentarios)) {
            noticia.subtitulos.forEach((sub, i) => {
              // Evita errores si no hay comentario en esa posición
          ...
          document.getElementById("noticia").innerHTML = `
            ...
            ${noticia.imagen ? `<img src="${noticia.imagen}" alt="Imagen de noticia" style="max-width:100%; border-radius:10px; margin:10px 0;">` : ""}
