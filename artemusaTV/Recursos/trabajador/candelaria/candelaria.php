    ...
    <div class="main-container">
        ...
        <div class="left-column">
            ...
            <div id="modal-noticia" class="modal">
                <div class="modal-content">
                    ...
                    <form method="POST" action="agregarC.php" enctype="multipart/form-data" class="form-noticia">
                        ...
                        <div class="form-buttons">
                            ...
                            <button type="button" class="btn-cancelar" onclick="document.getElementById('modal-noticia').style.display='none'">Cancelar</button>
                        </div>
                    </form>
                </div>
            </div>
            ...
            ================================ -->
            <div id="modal-detalle" class="img-modal">
        ...
        <div class="right-column">
            <div class="card">
                ...
                <img src="../../publicidad/publiciad15.jpg" alt="sikuris" class="publi-img">
                <!-- Segundo video -->
                <video controls autoplay muted loop>
